...
`renv` is the R package for reproducible environments (check [`virtualenv`](https://virtualenv.pypa.io/en/latest/) or [`pipenv`](https://pipenv.pypa.io/en/latest/) for pretty much the same stuff in Python). 
...
## A less 'overkill' approach is to use the new Groundhogr package
